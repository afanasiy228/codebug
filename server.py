...
PUBLIC_CLOUDINARY_CLOUD_NAME = os.getenv("PUBLIC_CLOUDINARY_CLOUD_NAME", "dez5af9sr")
PUBLIC_CLOUDINARY_UPLOAD_PRESET = os.getenv("PUBLIC_CLOUDINARY_UPLOAD_PRESET", "codebug_uploads")
